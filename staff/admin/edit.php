...
$id = $_GET['id']; // access this super global ($_GET) and asks for the value that have been sent in & assigns them to local variable
if(is_post_request()) {
    //associative array
    $admin = [];
    $admin['id'] = $id;
...
<div id="content">
    ...
    <div class="admin edit">
        ...
        -->
            ...
            <p>Password should be at least 12 characters and include at least one uppercase letter, lowercase letter,
                number,
                and symbol.
            </p>
            <br />
